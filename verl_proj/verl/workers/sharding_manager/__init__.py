...
if is_megatron_core_available() and is_vllm_available():
    try:
        ...
        logger.warning("Disabling MegatronVLLMShardingManager because vllm import failed: %s", exc)
        AllGatherPPModel = None
...
if is_vllm_available():
    try:
        ...
        logger.warning("Disabling FSDPVLLMShardingManager because vllm import failed: %s", exc)
