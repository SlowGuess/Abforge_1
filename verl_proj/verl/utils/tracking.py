...
class Tracking(object):
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = 'console', config=None):
        ...
        if 'tracking' in default_backend or 'wandb' in default_backend:
            ...
            # WANDB_FORK_FROM lets us branch a fresh run off a previous run at a given step
            # (format: "<run_id>?_step=<N>"). Useful for resuming training after a bad
            # stretch — the new curve visually continues from the fork point.
            fork_from = os.environ.get("WANDB_FORK_FROM")
            if fork_from:
